...
import com.jisj.winsearch.sql.WinSearchConnection;
import com.jisj.winsearch.sql.WinSearchStatement;
import com.jisj.winsearch.sql.WinSearchResultSet;
...
import static com.jisj.winsearch.QueryBuilder.ComparisonPredicate.Contains;
import static com.jisj.winsearch.QueryBuilder.ComparisonPredicate.FreeText;
...
public class QueryExecutor {
    ...
    /**
     * Adds string names of {@link WinProperty WinProperty} to SQL query. Duplicate property names are ignored
     *
     * @param properties {@link WinProperty WinProperty} names string values
     */
     ...
     * Adds string names of {@link WinProperty WinProperty} to SQL query. Duplicate property names are ignored
     *
     * @param properties {@link WinProperty WinProperty}
     */
    ...
    /**
     * Gets state of {@link WinSearchStatement WinSearchStatement} after query execution
     *
